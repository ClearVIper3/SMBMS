<%@ page language="java" contentType="text/html; charset=UTF-8"
         pageEncoding="UTF-8"%>
<input type="hidden" id="path" value="${pageContext.request.contextPath}" /> <!--拿到 Web 应用的上下文路径-->
    ...
    <div class="providerAdd">
        <form id="providerForm" name="providerForm" method="post" action="${pageContext.request.contextPath }/jsp/provider.do">
            ...
            <div>
                ...
                <input type="text" name="userAddress" id="proAddress" value="${provider.userAddress }">
            </div>

            <div>
                <label for="proFax">传真：</label>
                <input type="text" name="userFax" id="proFax" value="${provider.userFax }">
            </div>
